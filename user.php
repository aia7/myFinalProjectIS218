    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1><p align="left">Incomplete :</p></h1><button type="button" class="btn btn-outline-danger" style="background-color: #ff0000 style= text-color: #ffffff" >+ Add A New Task</button><br>
